...
def test_integration_on_circle(radius):
    ...
    integral_sphere = mesh_sphere.waterline_integral(np.ones(mesh_sphere.nb_faces_waterline))
...
def test_integration_on_rectangle(l, L, h): 
    ...
    integral_rectangle = mesh_rectangle.waterline_integral(np.ones(mesh_rectangle.nb_faces_waterline))
